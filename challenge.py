class ProgramLearningBot:
    ...
    def __init__(self):
        self.levels = [
            ...
            # level 4: introducing runtime error in division
            {
                "level": "num1 = 10 "
                         "num2 = 5 "
                         "quotient = num1 / num2 "
            ...
            # level 10: introducing logical and semantic error in Armstrong program
            {
            ...
            # level 12: Finding the number of words/spaces
            {
    ...
    def submit_solution(self, solution):
        ...
        if solution == correct_solution:
            self.currentLevel += 1
            return "Correct! Moving to the next challenge."
        else:
    ...
    while True:
        ...
        if solution.lower() in ["exit", "quit"]:
            ...
            if bot.currentLevel < len(bot.levels) - 1:
                ...
                print("You've completed all the challenges.")
